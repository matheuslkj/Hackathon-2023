package com.unialfa.transporte;
...
import com.unialfa.transporte.datasource.ApiService;
import com.unialfa.transporte.datasource.Transporte;
                ...
                if (response.isSuccessful()) {
                    ...
                    if (transportes != null && !transportes.isEmpty()) {
                        ...
                        for (int i = 0; i < transportes.size(); i++) {
                            ...
                            localSaidaDestino[i] = "de: " + transporte.getLocalPartida() + " para: " + transporte.getDestino();
                        }
